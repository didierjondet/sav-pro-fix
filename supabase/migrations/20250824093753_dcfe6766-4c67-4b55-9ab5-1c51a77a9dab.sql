-- Activer la réplication temps réel pour sav_messages
ALTER TABLE sav_messages REPLICA IDENTITY FULL;
ALTER PUBLICATION supabase_realtime ADD TABLE sav_messages;
