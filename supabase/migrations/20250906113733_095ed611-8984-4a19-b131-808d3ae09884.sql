-- Corriger la fonction get_tracking_info pour utiliser le bon type sav_type
-- La colonne sav_type est de type enum sav_type, pas text

DROP FUNCTION IF EXISTS public.get_tracking_info(text);

-- Créer la fonction corrigée avec le bon type de retour pour sav_type
