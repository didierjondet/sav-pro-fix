      ...
      <div className="flex items-center justify-between h-16 px-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            {shop?.logo_url ? <img src={shop.logo_url} alt="Logo du magasin" className="h-12 w-12 object-contain" /> : <img src="/lovable-uploads/3d99a913-9d52-4f6c-9a65-78b3bd561739.png" alt="Logo FixWay Pro" className="h-12 w-12 object-contain" />}
